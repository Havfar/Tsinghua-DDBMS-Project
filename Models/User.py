...
class User:
    ...
    def __init__(self, id=None, uid=None, timestamp=None, name=None,
        ...
        if input_string == None:
            ...
            self.age = input_string[9].replace("'", "")
            self.region = input_string[10].replace("'", "")
            self.role = input_string[11].replace("'", "")
            self.prefer_tags = input_string[12].replace("'", "")
            self.obtained_credits = input_string[13].replace("'", "")
